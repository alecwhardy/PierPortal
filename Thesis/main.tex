...
\usepackage{color}
\usepackage[table]{xcolor} % AWH: Added 2/19/20
...
% Let's standardize tables!
% AWH: Added 2/24/20
\setlength{\arrayrulewidth}{0.2mm} % Fix table borders by making them 0.2mm thick, otherwise \rowcolor breaks the border
